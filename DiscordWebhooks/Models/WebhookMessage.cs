...
using ShimmyMySherbet.DiscordWebhooks.Models.Attachments;
...
namespace ShimmyMySherbet.DiscordWebhooks.Models
{
    ...
    public class WebhookMessage
    {
        ...
        public List<WebhookAttachment> Attachments { get; set; } = new List<WebhookAttachment>();
        ...
        public WebhookMessage WithAttachment(string filename, string description = null)
        {
            var attachment = new WebhookAttachment()
            {
                ...
                Content = new FileAttachmentContent(filename)
            };
